<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="java.util.*" import="java.sql.*,sh.*"%>
...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
   ...
   <link rel="stylesheet" href="css2/info.css" media="screen">
                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="index2.jsp"><i class="fa fa-heart"></i> Home</a></li>
