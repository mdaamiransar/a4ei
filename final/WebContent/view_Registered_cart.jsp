...
<li>
   ...
   <div id="qq"></div>
	...
	%>                           
                                 <tbody>
                                        <tr class="cart_item" width="500" height="145">
                                            <td class="product-remove" width="1000px" height="145">
                                               <a href="remove_buy?product_id=<%=ob.getProduct_id()%>"  title="Remove this item"  class="remove">Remove</a><hr>
                                            </td>

                                            <td class="product-thumbnail"width="100%" height="145">
                            ...
                            <div>
                                            <span style=margin-left:50px><a href="index2.jsp" style="margin-left:-2px">Continue Shopping</a></span>
                                         
                                         
                                         
                                        
                                        
                                          <a href="Place_Order.jsp?email=<%=email2%>&count=<%=cnt%>&order_total_price=<%=order_total_price%>">Place Order</a>
                                           </div>
                                            </td>
                                        </tr>
