      ...
      <!-- End mainmenu area --></br></br></br></br>
        ...
        <div class="row">
                   ...
                   int Product_id=Integer.parseInt(request.getParameter("product_id"));
                    ...
                    String sql123="select FILE_NAME from image where PRODUCT_ID=?";
                    PreparedStatement ps123=con1.prepareStatement(sql123);
                	ps123.setInt(1,Product_id);
                	 ResultSet rs123=ps123.executeQuery();
                	 if(rs123.next())
                	 {
                		 
                    String filename=rs123.getString("FILE_NAME");
                    System.out.println("zzzzzzzzzzzzzzzzzzzzzz "+filename);
                    ...
                    String color=rs.getString(8);
                      ...
                      System.out.println("pid in aaaaaaaaaaaaaaaaaaaaaaa"+product_name); 
