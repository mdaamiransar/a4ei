...
<div class="mobile6b">
 <table id="mobile6b" border="1" cellspacing="5px" cellpadding="5px" align="center">
 <%
						...
						ps4.setString(1,CATEGORY_NAME );
						ResultSet rs4=ps4.executeQuery();
						if(rs4.next())		
						{
							System.out.println(1);
							int CATEGORY_ID=rs4.getInt("CATEGORY_ID");
							...
							while(rs1.next())
							{
						      System.out.println(2);%>
								<tr><td colspan="3">
								<div><% String SUBCATEGORY_NAME= rs1.getString("SUBCATEGORY_NAME");
								System.out.println("SUBCATEGORY_NAME"+SUBCATEGORY_NAME);
								int SUBCATEGORY_ID= rs1.getInt("SUBCATEGORY_ID");%>
								<h2 align="center"><%=SUBCATEGORY_NAME%></h2>
								</div></td></tr>
								<tr><td colspan="3" style="padding: 10px;"><table  border="1" cellspacing="5px" cellpadding="5px">
					                ...
					                %>
					                     <tr style="width: 1%;height: 1%">
					                         ...
					                         for(int i=1;i<=3;) {
					                         	  ...
					                         	  <td style="width: 1%;height: 1%; padding: 10px;" >
