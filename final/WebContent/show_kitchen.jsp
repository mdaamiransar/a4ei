...
<ul style="list-style-type: none;">
						...
						<li><a href="mobile.jsp?subcategory=dinr set"><img src="img/DINR SET.jpeg"
							style="margin-top: 20px; width: 210px; height: 160px; display: block; position: relative;">DINR SET</a></li>
						
						<li style="margin-top:-180px; margin-left: 330px;"><a href="mobile.jsp?subcategory=kooker"><img
							src="img/KOOKER.jpeg"
							style="width: 210px; height: 160px; display: block; position: relative;">KOOKER</a></li>
						<li style="margin-top:-180px; margin-left: 700px;"><a href="mobile.jsp?subcategory=microoven"><img
							src="img/MICROOVEN.jpeg"
							style="width: 210px; height: 160px; display: block; position: relative;">MICROOVEN</a></li>
						<li style="margin-top:-180px; margin-left: 1000px;"><a href="mobile.jsp?subcategory=post and pan set"><img
							src="img/POTS AND PAN SET.jpeg"
							style="width: 210px; height: 160px; display: block; position: relative;">POTS AND PAN SET</a></li>
