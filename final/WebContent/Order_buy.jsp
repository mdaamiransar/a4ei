...
<meta charset="utf-8">
    ...
    <![endif]-->
    <script>function login(showhide) {
		if (showhide == "show") {
...
session.setAttribute("cart_list",cart_list);
  ...
  if(it.hasNext())
  {
	 ...
	 j=Dao_Cart.Insert_Order_cart(order_details_id, product_id, name, price, quantity,seller);
...
if(i==1 && j==1 && k==1)
 {%>
   ...
   <div>Expected Delivery Date <%=delivery_date %> </div>
   <%} %>
