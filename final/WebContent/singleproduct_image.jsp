...
String sql="select QUANTITY from color where PRODUCT_ID=? and COLOR_ID=?";
    ...
    <div class="footer-top-area">
        ...
        <div class="container">
			...
			System.out.println("Email is" + email5);
			if (email5 != null) {
				
		%>
                  <li><a  href="return.jsp"> <%=email5 %>RETURN</a></li>
                           
                    
		
<%} else{%>
		        <li><a  href="login4.jsp">RETURN</a></li>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; 2016 E-SAMAGRI All Rights Reserved. <a href="http://www.freshdesignweb.com" target="_blank">SSTL.com</a></p>
                    </div>
                </div>
    ...
    <!-- Slider -->
    <script type="text/javascript" src="js2/bxslider.min.js"></script>
	<script type="text/javascript" src="js2/script.slider.js"></script>
  </body>
